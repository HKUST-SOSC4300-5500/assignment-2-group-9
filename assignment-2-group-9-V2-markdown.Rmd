...
```
The scores are rather underwhelming. Since we also used other algorithm on Python which performed significantly better and actually beat naive bayes, compared to glmnet and xgboost who did not, we didn't go any further in tuning. 
