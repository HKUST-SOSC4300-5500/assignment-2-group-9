...
dtrain <- xgb.DMatrix(data = data.train.red, label = data.train$user_suggestion) 
...
xgbcv <- xgb.cv( params = params, data = data.train.red,label = data.train$user_suggestion,
                 nrounds = 1000, 
                 nfold = 5, 
                 showsd = T, 
                 stratified = T, 
